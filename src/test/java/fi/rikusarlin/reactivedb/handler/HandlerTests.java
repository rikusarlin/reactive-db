...
public class HandlerTests 
{
    ...
    void testCreatePerson() {
        ...
        Mockito.verify(personServer, times(1)).createNewPerson(Mockito.any(Person.class), Mockito.anyString());
    }
    ...
    void testUpdatePerson() {
        ...
        this.webClient.put()
            ...
            .expectBody()
            .jsonPath("$.lastName").isEqualTo("Wnape");
        Mockito.verify(personServer, times(1)).updatePerson(Mockito.any(Person.class), Mockito.anyString());
    }
